...
**Solution:** [libholberton.so](https://github.com/essilfiequansah/alx-low_level_programming/blob/main/0x18-dynamic_libraries/libdynamic.so), [holberton.h](https://github.com/essilfiequansah/alx-low_level_programming/blob/main/0x18-dynamic_libraries/main.h)

## 1. Without libraries what have we? We have no past and no future

Create a script that creates a dynamic library called `liball.so` from all the `.c` files that are in the current directory.

**Solution:** [1-create_dynamic_lib.sh](https://github.com/essilfiequansah/alx-low_level_programming/blob/main/0x18-dynamic_libraries/1-create_dynamic_lib.sh)
...
**Solution:** [100-operations.so](https://github.com/essilfiequansah/alx-low_level_programming/blob/main/0x18-dynamic_libraries/100-operations.so)
...
- You can’t modify the program `gm` itself as main Sysadmin Sylvain (MSS) always checks its [MD5](https://github.com/holbertonschool/0x18.c/blob/main/101-md5_gm) before running it
...
**Solution:** [101-make_me_win.sh](https://github.com/essilfiequansah/alx-low_level_programming/blob/main/0x18-dynamic_libraries/101-make_me_win.sh)
